...
<p class="breadcrumbs">
  <b>
    ...
    <span class="mr-2">NICE Ring Road --<i class="ion-ios-arrow-forward"></i></span> 
    <span class="mr-2">Kanakpura (via NH948) --<i class="ion-ios-arrow-forward"></i></span> 
    <span class="mr-2">Gaganachukki falls --<i class="ion-ios-arrow-forward"></i></span> 
    <span class="mr-2">Bharachukki falls --<i class="ion-ios-arrow-forward"></i></span> 
    <span class="mr-2">Maddur --<i class="ion-ios-arrow-forward"></i></span> 
    <span class="mr-2">Ramnagara (via SH17) --<i class="ion-ios-arrow-forward"></i></span> 
    <span class="mr-2">NICE Ring Road --<i class="ion-ios-arrow-forward"></i></span> 
